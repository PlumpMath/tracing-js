...
traceLine(4); for (var i = 0; traceLine(4),traceValue("i < string.length", i < string.length); traceLine(4),traceWrite("i", i++)) {
	traceLine(5); var j = 0;
	traceLine(5); while (traceLine(5),traceValue("j < pattern.length", j < pattern.length)
